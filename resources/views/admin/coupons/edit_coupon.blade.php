             ...
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/edit-coupon/'.$couponDetails->id)}}" method="post" name="edit_coupon" id="edit_coupon"> {{csrf_field()}}
                      ...
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control" value="{{$couponDetails->coupon_amount}}" name="amount" id="amount" required>
                      </div>
                      <div class="form-group">
                        <label>Tipo de cantidad</label>
                        <select name="amount_type" id="amount_type" class="form-control">
                        <option  @if($couponDetails->amount_type=="Percentage") selected @endif value="Percentage">Porcentaje</option>
                        <option  @if($couponDetails->amount_type=="Fixed") selected @endif value="Fixed">Fijo</option>
                        </select>
                      ...
                      <div class="form-group">
                         ...
                         <div class="controls">
                      <input type="checkbox" class="form-control" name="status" id="coupon_status"   @if($couponDetails->status == "1") checked @endif value="1">
                      </div>
                      </div>
                      <div class="reset-button">
                         <input type="submit" class="btn btn-success" value="Editar Cupon">
                      </div>
                   </form>
                </div>
             </div>
