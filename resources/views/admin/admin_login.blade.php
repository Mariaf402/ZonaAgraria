                    ...
                    <div class="panel-heading">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3>ZonAgraria</h3>
                                <small><strong>Porfavor ingresa tus datos</strong></small>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <form action="{{url('admin')}}" id="loginForm" method="post"> {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="example@gmail.com" title="Porfavor ingresa tu Usuario" required="" value="" name="username" id="username" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div>
                                <button class="btn btn-add">Iniciar Sesion</button>
                                <button class="btn btn-add">Registrase</button>
                            </div>
                        </form>
                        </div>
                        </div>
