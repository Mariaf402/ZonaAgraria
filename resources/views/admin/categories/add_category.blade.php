             ...
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" action="{{url('/admin/add-category')}}" method="post"> {{csrf_field()}}
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control" placeholder="Nombre de la Categoria" name="category_name" id="category_name" required>
                      </div>
                      <div class="form-group">
                         <label>Categoria Asociada</label>
                         <select name="parent_id" id="parent_id" class="form-control" required>
                             <option value="0">Poner En Categoria Principal</option>
                      ...
                      <div class="form-group">
                         ...
                         <div class="controls">
                      <input type="checkbox" class="form-control" name="status" id="category_name" value="1">
                      </div>
