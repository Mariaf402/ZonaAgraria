...
class AdminController extends Controller
{
    ...
    public function updatePassword(Request $request){
        if($request->isMethod('post')){
            ...
            if ($adminCount == 1) {
                ...
                return redirect('/admin/settings')->with('flash_message_error', 'La contraseña actual ingresada es incorrecta.');
            }
    ...
    public function logout(){
        Session::flush();
        return redirect('/admin')->with('flash_message_success', 'Sesión cerrada correctamente.');
    }
    ...
    public function addAdmin(Request $request){
        if($request->isMethod('post')){
            ...
            if($adminCount>0){
                return redirect()->back()->with('flash_message_error','¡El administrador / subadministrador ya existe! Por favor, elija otro.');
            }else{
                ...
                if($data['type']=="Admin"){
                    ...
                    $admin->save();
                    return redirect()->back()->with('flash_message_success','¡El subadministrador se agregó correctamente!');
                }
    ...
    public function editAdmin(Request $request, $id){
        ...
        if($request->isMethod('post')){
            ...
            if($data['type']=="Admin"){
                ...
                return redirect()->back()->with('flash_message_success','¡El administrador se actualizó correctamente!');
            }else if($data['type']=="Sub Admin"){
                if(empty($data['categories_view_access'])){
                    $data['categories_view_access'] = 0;
                }
                ...
                return redirect()->back()->with('flash_message_success','¡El administrador secundario se actualizó correctamente!');
            }
